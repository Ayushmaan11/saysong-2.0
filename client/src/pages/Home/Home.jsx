    ...
    <div className='home'>
      ...
      <div className="features">
        <div className="container">
          <div className="item">
            <h1>A whole world of talented music-artists at your fingertips</h1>
            <div className="title">
            ...
            <div className="title">
              <img src="./media/check.png" alt="check" />
              <h6>Quality music produced</h6>
            </div>
            <p>Find the right artist to begin working on your song within minutes.</p>
            <div className="title">
              <img src="./media/check.png" alt="check" />
      ...
      <div className="features dark">
        <div className="container">
          <div className="item">
            <h2>SaySong business</h2>
            <h1>A business solution designed for <span>Musicians</span></h1>
            <p>Upgrade to a curated experience packed with tools and benefits, dedicated to musicians and artists</p>
            <div className="title">
              <img src="./media/check.png" alt="check" />
              <h6>Connect to artists with proven business experience</h6>
            </div>
            <div className="title">
              <img src="./media/check.png" alt="check" />
            ...
            <button>Explore SaySong Business</button>
          </div>
          <div className="item">
