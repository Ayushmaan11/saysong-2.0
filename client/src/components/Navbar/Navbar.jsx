...
const Navbar = () => {
  ...
  const menuLinks = [
    { path: "/gigs?category=design", name: "Country music" },
    { path: "/gigs?category=video", name: "Romantic Tunes" },
    { path: "/gigs?category=books", name: "Customized Lyrics" },
    { path: "/gigs?category=ai", name: "Expressive Tunes" },
    { path: "/gigs?category=social", name: "Metal and Rock" },
    { path: "/gigs?category=voice", name: "Music & Audi" },
    { path: "/gigs?category=wordpress", name: "Tunes" },
  ];
      ...
      <div className="container">
        <div className="logo">
          <Link to="/" className="link">
            <span className="text">SaySong</span>
          </Link>
        ...
        <div className="links">
          <div className="menu-links">
            ...
            <span>Explore</span>
            <span>English</span>
            {!user?.isSeller && <span>Become an Artist</span>}
          </div>
          {isLoading ? (
            <Loader size={35} />
          ) : (
